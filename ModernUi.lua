...
-- ===============================
-- UI Elements with table support
-- ===============================

-- Button
function ModernUi:Button(parent, data)
    local title, callback = "Button", nil
...
-- Toggle
function ModernUi:Toggle(parent, data)
    local text = "Toggle"
    local callback = nil
    if type(data) == "table" then
...
-- Slider
function ModernUi:Slider(parent, data)
    local text = "Slider"
    local callback = nil
    if type(data) == "table" then
    ...
    -- Callback support
    if callback then
        -- connect drag events here if needed
    end
...
-- Input
function ModernUi:Input(parent, data)
    local placeholder = "Input"
    local callback = nil
    if type(data) == "table" then
        placeholder = data.Placeholder or "Input"
        callback = data.Callback
    elseif type(data) == "string" then
        placeholder = data
    end
